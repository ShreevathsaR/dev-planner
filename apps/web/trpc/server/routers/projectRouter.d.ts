...
export declare const projectRouter: import("@trpc/server").TRPCBuiltRouter<{
    ...
    updateProject: import("@trpc/server").TRPCMutationProcedure<{
        ...
        output: {
            success: boolean;
            message: string;
            data: import("@dev-planner/prisma/generated/client/runtime/library").DynamicModelExtensionFluentApi<Prisma.TypeMap<import("@dev-planner/prisma/generated/client/runtime/library").InternalArgs & {
                result: {};
                model: {
                    $allModels: {
