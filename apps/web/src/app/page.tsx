...
export default function LandingPage() {
  ...
  const redirectToApp = () => {
    alert("DevPlanner Mobile App Access Request\n\nPlease email feedbacklib.app@gmail.com to request access to the mobile app preview.")
    window.location.href =
      "https://appdistribution.firebase.google.com/testerapps/1:710907599444:android:9cb6717db518643ba9ebc1/releases/2a0ihj7271o78?utm_source=firebase-console";
  };
        ...
        <div className="text-center space-y-8">
          ...
          <div className="animate-slide-up [animation-delay:400ms]">
            <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
              ...
              planning, seamless team collaboration, and automated progress
              tracking.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up [animation-delay:600ms]">
            ...
            <Button
              ...
              variant="outline"
              onClick={() => redirectToApp()}
              className="border-white/30 text-black hover:text-white font-bold hover:bg-white/10 hover:border-white/50 px-8 py-6 text-lg backdrop-blur-sm hover:-translate-y-1"
            >
              Mobile App
            </Button>
          </div>
        ...
        <section className="mt-32 text-center">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-12 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of teams who are already building better software
              with DevPlanner`&apos;`s intelligent project management platform.
            </p>
            <Button
              size="lg"
